...
<head>
    ...
    <link rel="icon" type="imagejpg/" href="logolink1.jpg">
    <link rel="stylesheet" href="style.css"/>
</head>

<body style="background-image: url('bgyo.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">  
<div id="wrapper">
    <div id="header">
        ...
        <div id="footer">
            <h4 style="color: #6b3b08">ANYOASEO</h4>
        </div>
    </div>
</div>
